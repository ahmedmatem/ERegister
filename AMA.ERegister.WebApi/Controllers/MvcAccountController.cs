namespace AMA.ERegister.WebApi.Controllers
{
    using System;
    ...
    using AMA.ERegister.WebApi.Infrastructure;
    using AMA.ERegister.WebApi.Models;
    using Microsoft.AspNet.Identity;
    using Microsoft.AspNet.Identity.Owin;
    using Microsoft.Owin.Security;
    using static AMA.ERegister.WebApi.ApplicationUserManager;
    ...
    public class MvcAccountController : Controller
    {
        ...
        public MvcAccountController(ApplicationUserManager userManager,
        ...
        private async Task<ActionResult> RedirectAccordingRoleAsync(LoginViewModel model, string returnUrl)
        {
            ...
            if (UserManager.IsInRole(user.Id, WebRoles.SupperAdmin))
            {
                return RedirectToAction("Index", "Home", new { area = "AdminPage" });
            }
        ...
        //
        // GET: /MvcAccount/ExternalLoginCallback
        [AllowAnonymous]
        ...
        //
        // POST: /MvcAccount/ExternalLoginConfirmation
        [HttpPost]
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        ...
        //
        // GET: /MvcAccount/ExternalLoginFailure
        [AllowAnonymous]
